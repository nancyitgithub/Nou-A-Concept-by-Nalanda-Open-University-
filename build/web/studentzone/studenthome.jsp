...
<div class="row onBackground ">
            ...
            <div class="container-fluid">
             ...
             <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="studymaterial.jsp"><i class="bi bi-textarea-t  mx-2"></i>Study Material</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="row mt-2">
      <div class="col-sm-12" style="background-color: aliceblue; min-height:600px;">
          <h2 style="color: blue;text-align: center;">View Profile</h2>

...
if(session.getAttribute("rollno")==null){
    response.sendRedirect("../login.jsp");
      ...
      out.write("          <h2 style=\"color:blue;text-align: center;\">Submit Your Response </h2>\n");
      out.write("          <form action=\"studentcontroller.jsp\" method=\"post\" class=\"form-group\">\n");
      out.write("              <input type=\"hidden\" name=\"page\" value=\"response\">\n");
      out.write("              <table style=\"width: 60%;margin: auto;\" class=\"table table-border\">\n");
      out.write("                  <tr>\n");
      out.write("                      <td>Select Response Type</td>\n");
      out.write("                      <td><select name=\"responsetype\" class=\"form-control\">\n");
      out.write("                              <option selected>--Select Response Type-- </option>\n");
